...
if __name__=="__main__":
    ...
    if pargs.use_simignore == True:
        ...
        model.config.fast_v_agg_layer = 5
        model.config.model_name = 'llava_1.5_7b'

        model.config.simignore_step = 1
        model.config.simignore_k2 = 452
        model.config.simignore_i_index = 1
    else:
