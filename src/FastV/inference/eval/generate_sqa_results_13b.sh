...
for rank in ${rank_list[@]}; do
    ...
    --result-file $result_file/sqa_test_image_13b_FASTV_4bit_inplace_${rank}_${k}.jsonl  \
    --output-file $output_path/sqa_test_image_13b_FASTV_4bit_inplace_${rank}_${k}_output.json \
    --output-result $output_path/sqa_test_image_13b_FASTV_4bit_inplace_${rank}_${k}_result.json
    done
done
